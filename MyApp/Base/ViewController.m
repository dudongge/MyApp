...
- (void)viewDidLoad {
    ...
    self.myButton.frame = CGRectMake(100, 100, 180, 40);
    ...
    [self.myButton setTitle:@"选中的=了" withState:UIControlStateSelected];
    [self.myButton setTitle:@"删除" withState:UIControlStateHighlighted];
    [self.myButton setTitle:@"不可用" withState:UIControlStateDisabled];
    ...
    self.rightButton.frame = CGRectMake(100, 200, 180, 40);
    ...
    [self.rightButton setTitle:@"选中的=了" withState:UIControlStateSelected];
    [self.rightButton setTitle:@"删除" withState:UIControlStateHighlighted];
    [self.rightButton setTitle:@"不可用" withState:UIControlStateDisabled];
    ...
    self.topButton.frame = CGRectMake(100, 300, 180, 70);
    ...
    [self.topButton setTitle:@"选中的=了" withState:UIControlStateSelected];
    [self.topButton setTitle:@"删除" withState:UIControlStateHighlighted];
    ...
    self.bottomButton.frame = CGRectMake(100, 400, 180, 80);
    self.bottomButton.backgroundColor = UIColor.grayColor;
    ...
    [self.bottomButton setTitle:@"选中的=了" withState:UIControlStateSelected];
    [self.bottomButton setTitle:@"删除" withState:UIControlStateHighlighted];
    ...
    self.titleColorButton.frame = CGRectMake(100, 500, 180, 50);
    self.titleColorButton.backgroundColor = UIColor.grayColor;
    
    self.attButton.frame = CGRectMake(100, 600, 180, 50);
    ...
    NSString *yellorAttribute = [NSString stringWithFormat:@"需支付漫币"];
    ...
    NSString *redAttribute = [NSString stringWithFormat:@"oodf需支付23漫币"];
    ...
    NSString *greenAttribute = [NSString stringWithFormat:@"oodf需支付漫币"];
...
- (MyButton *)attButton {
    if (!_attButton) {
        NSString *needCoinsAttribute = [NSString stringWithFormat:@"需支付漫币"];
        NSRange range = NSMakeRange(2, 2);
